					...
					<div class="wrap about-wrap access-wrap">
						<div class="top-block-wrap">
							<div class="about-text">
								...
								<h1><?php /* translators: 1: theme name, 2: version numbers */
								printf( esc_html__( 'Welcome to %s - Version %s', 'punte' ), $this->theme_name, $this->theme_version ); ?></h1>
						...
						public function plugin_activation_callback() {
							if( !current_user_can('activate_plugins') )
								wp_die( esc_html__( 'Sorry, you are not allowed to activate plugins on this site.', 'punte' ) );
						...
						public function plugin_deactivation_callback() {
							if( !current_user_can('activate_plugins') )
								wp_die( esc_html__( 'Sorry, you are not allowed to deactivate plugins on this site.', 'punte' ) );
