...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'enable-plx-menu',
            'type' => 'switch',
            'title' => esc_html__( 'OnePage Menus', 'punte' ),
            'desc' => esc_html__('Enable single page scrolling menus','punte'),
            'default' => false,
            'on' => esc_html__( 'Enable', 'punte' ),
            'off' => esc_html__( 'Disable', 'punte' )
        ),
...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type' => 'switch',
            'title' => esc_html__( 'Show Footer Widgets', 'punte' ),
            'default' => true,
            'on' => esc_html__( 'Show', 'punte' ),
            'off' => esc_html__( 'Hide', 'punte' )
        ),
...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'subtitle' => esc_html__( 'Show Featured Image of Archive Post', 'punte' ),
            'default' => true,
            'on' => esc_html__( 'Show', 'punte' ),
            'off' => esc_html__( 'Hide', 'punte' ),
        ),
